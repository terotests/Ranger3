...
class BasicAST  {
  ...
  blockCtxTest (testCtx) {
    ...
    vd_2 = (vd_2).set_value((operatorsOf_11.literal_13("<div/>")));
    ...
    vd_3 = (vd_3).set_value((operatorsOf_11.literal_13("FOOBARDOM")));
    ...
    vd_4 = (vd_4).set_value((operatorsOf_17.literal_18(1234)));
...
operatorsOfVector.push_21 = function(__self, item) {
  return __self.add(item);
};
...
operatorsOf_4.forEach_20 = function(__self, cb) {
  for ( let i_3 = 0; i_3 < __self.length; i_3++) {
    var it_1 = __self[i_3];
    cb(it_1, i_3);
  };
};
operatorsOf_4.forEach_22 = function(__self, cb) {
...
operatorsOf_7.set_26 = function(__self, key, value) {
  const c_1 = new Map_string_ROperatorDef();
  const keys_1 = Object.keys(__self.elements);
  for ( let i_6 = 0; i_6 < keys_1.length; i_6++) {
    var k_1 = keys_1[i_6];
    if ( k_1 == key ) {
    } else {
...
operatorsOfstring_11.rc46def_12 = function(name, typename) {
  let vd = new RDefVariable();
  vd = (vd).set_name(name);
  vd = (vd).set_typename("");
  return vd;
...
operatorsOf_11.rc46vref_13 = function(name) {
...
operatorsOf_11.opc46param_12 = function(name, type_name) {
  let p_1 = new ROperatorParam();
  p_1 = (p_1).set_name(name);
  p_1 = (p_1).set_type_name(type_name);
  return p_1;
};
operatorsOf_11.cmdc46text_13 = function(txt) {
  let p_3 = new ROpCmdWriteText();
  p_3 = (p_3).set_text(txt);
  return p_3;
};
operatorsOf_11.opc46def_19 = function(lang, versions, params, cmds) {
  let n_2 = new ROperatorDef();
  n_2 = (n_2).set_lang(lang);
  n_2 = (n_2).set_versions(versions);
  operatorsOf_4.forEach_20(params, ((item, index) => { 
    n_2 = (n_2).set_params(operatorsOfVector.push_21(n_2.params, item));
  }));
  operatorsOf_4.forEach_22(cmds, ((item, index) => { 
    n_2 = (n_2).set_cmds(operatorsOfVector.push_23(n_2.cmds, item));
  }));
  return n_2;
};
operatorsOf_11.opc46collection_24 = function(opName, params) {
  let n_3 = new ROperatorCollection();
  n_3 = (n_3).set_name(opName);
  operatorsOf_4.forEach_25(params, ((item, index) => { 
    n_3 = (n_3).set_langs(operatorsOf_7.set_26(n_3.langs, item.lang, item));
  }));
  return n_3;
};
...
operatorsOf_14.rc46expr_15 = function(children) {
  let n = new RExpression();
  operatorsOf_4.forEach_5(children, ((item, index) => { 
    n = (n).set_children(operatorsOfVector.push_6(n.children, item));
  }));
  return n;
};
operatorsOf_14.rc46block_15 = function(children) {
  let n_1 = new RBlockNode();
  operatorsOf_4.forEach_5(children, ((item, index) => { 
    n_1 = (n_1).set_children(operatorsOfVector.push_6(n_1.children, item));
  }));
  return n_1;
};
...
operatorsOfint_17.cmdc46param_18 = function(index) {
...
operatorsOf_17.cmdc46param_18 = function(index) {
