...
CodeNodeLiteral.fromDictionary = function(dict) {
  ...
  try {
    ...
    if ( (typeof(values) !== "undefined" && values != null )  ) {
      const arr = values;
      operatorsOfJSONArrayObject_76.forEach_77(arr, ((item, index) => { 
    ...
    if ( (typeof(values_1) !== "undefined" && values_1 != null )  ) {
      ...
      operatorsOf_9.forEach_36(obj_keys, ((item, index) => { 
    ...
    if ( (typeof(values_2) !== "undefined" && values_2 != null )  ) {
      ...
      operatorsOf_76.forEach_77(arr_1, ((item, index) => { 
        if( typeof(item) === 'string' ) /* union case for string */ {
          var oo_1 = item;
    ...
    if ( (typeof(values_3) !== "undefined" && values_3 != null )  ) {
      ...
      operatorsOf_76.forEach_77(arr_2, ((item, index) => { 
    ...
    if ( (typeof(values_4) !== "undefined" && values_4 != null )  ) {
      ...
      operatorsOf_76.forEach_77(arr_3, ((item, index) => { 
        if( item instanceof Object ) /* union case */ {
          var oo_3 = item;
    ...
    if ( (typeof(values_5) !== "undefined" && values_5 != null )  ) {
      ...
      operatorsOf_76.forEach_77(arr_4, ((item, index) => { 
        if( item instanceof Object ) /* union case */ {
          var oo_4 = item;
...
class BasicAST  {
  ...
  testIterator (testCtx) {
    ...
    if( myGrammar instanceof RBlockNode ) /* union case */ {
      ...
      if( fc instanceof RExpression ) /* union case */ {
        var expr = fc;
        let rootIter = operatorsOf_3.nodec95iterator_16(expr.children);
            ...
            if( nameNode instanceof RVRefNode ) /* union case */ {
              ...
              if( eqNode instanceof RVRefNode ) /* union case */ {
                ...
                if ( eq.vref == "=" ) {
                  ...
                  const slice = operatorsOfRNodeIterator_17.cut_18((rootIter), ((item) => { 
                  ...
                  gCtx = (gCtx).set_rules(operatorsOfMap_19.set_20(gCtx.rules, name.vref, slice));
                }
              };
            };
          }
    ...
    /** unused:  const keys = operatorsOf_19.keys_21(gCtx.rules)   **/ 
    const test_ast = operatorsOf_5.createAST_6("+ + +");
    if( test_ast instanceof RBlockNode ) /* union case */ {
      ...
      if( fc_1 instanceof RExpression ) /* union case */ {
        var node_1 = fc_1;
        const iter_3 = operatorsOf_3.nodec95iterator_16(node_1.children);
        gCtx = (gCtx).set_codevec(iter_3);
        gCtx = operatorsOfgrammarCtx_22.collect_23(gCtx);
      };
    };
    ...
    if( op_ast instanceof RBlockNode ) /* union case */ {
      ...
      if( fc_2 instanceof RExpression ) /* union case */ {
        var node_3 = fc_2;
        console.log("--> RExpr found!! children " + operatorsOf_3.size_16(node_3.children));
        const iter_4 = operatorsOf_3.nodec95iterator_16(node_3.children);
    ...
    operatorsOf_12.walk_13(source_ast, ((item) => { 
      if( item instanceof RExpression ) /* union case */ {
        var node_7 = item;
        let iter_5 = operatorsOf_3.nodec95iterator_16(node_7.children);
        console.log("possibly found the x + y " + operatorsOf_3.size_16(node_7.children));
    ...
    operatorsOf_12.walk_13(op_ast, ((item) => { 
      ...
      if( item instanceof RExpression ) /* union case */ {
        var node_10 = item;
        let iter_6 = operatorsOf_3.nodec95iterator_16(node_10.children);
  ...
  writeFunction2 (inputWr) {
    let wr = inputWr;
    wr = operatorsOfCodeOutput_25.write_26(wr, "const myFnXX = () => {");
    wr = operatorsOf_25.nl_29(wr);
    wr = operatorsOf_25.indent_29(wr);
    wr = operatorsOf_25.write_26(wr, "return x + 1 ");
    wr = operatorsOf_25.nl_29(wr);
    wr = operatorsOf_25.unindent_29(wr);
    wr = operatorsOf_25.write_26(wr, "}");
    wr = operatorsOf_25.nl_29(wr);
    return wr;
  };
  writeFunctionBody (inputWr) {
    ...
    operatorsOf_9.forEach_30(items, ((item, index) => { 
      wr = operatorsOf_25.write_26(wr, ("let x = " + item));
      wr = operatorsOf_25.nl_29(wr);
  ...
  testCodeWriter (testCtx) {
    ...
    out = (out).set_tags(operatorsOf_19.set_31(out.tags, "imports", operatorsOf_25.fork_29(out)));
    let tagRef = new WriterTag();
    tagRef = (tagRef).set_name("imports");
    out = (out).set_slices(operatorsOf_3.push_28(out.slices, (tagRef)));
    out = operatorsOf_25.write_26(out, "\nfunction foobar() {\n\n}   \n");
    out = operatorsOf_25.write_26(out, "const myFn = () => {");
    out = operatorsOf_25.nl_29(out);
    out = operatorsOf_25.indent_29(out);
    out = this.writeFunctionBody(out);
    out = operatorsOf_25.nl_29(out);
    out = operatorsOf_25.unindent_29(out);
    out = operatorsOf_25.write_26(out, "}");
    out = operatorsOf_25.nl_29(out);
    let imp = operatorsOf_19.get_32(out.tags, "imports");
    imp = operatorsOf_25.write_26(imp, "import xyz from foobardom");
    imp = operatorsOf_25.nl_29(imp);
    out = (out).set_tags(operatorsOf_19.set_31(out.tags, "imports", imp));
    let imp_2 = operatorsOf_19.get_32(out.tags, "imports");
    imp_2 = operatorsOf_25.write_26(imp_2, "import foo from bar");
    imp_2 = operatorsOf_25.nl_29(imp_2);
    out = (out).set_tags(operatorsOf_19.set_31(out.tags, "imports", imp_2));
    const result = operatorsOf_25.getString_33(out, 0, "");
    console.log("--> got ");
    console.log(result);
  };
  walkNode (ctx) {
    ...
    if( ctx.activeNode instanceof RBlockNode ) /* union case */ {
      ...
      operatorsOf_9.forEach_40(new_children, ((item, index) => { 
    ...
    if( ctx.activeNode instanceof RIncExpression ) /* union case */ {
      ...
      let newCtx_1 = ctx;
      let myVar = operatorsOf_19.get_41(newCtx_1.variables, b_3.name);
      if ( (typeof(myVar) !== "undefined" && myVar != null )  ) {
        const defined_here = operatorsOf_19.get_41(newCtx_1.defined_vars, b_3.name);
        ...
        if ( ((typeof(ctx.outerBlock) !== "undefined" && ctx.outerBlock != null ) ) && (typeof(defined_here) === "undefined") ) {
          const outerVar = operatorsOf_19.get_41(ctx.outerBlock.variables, b_3.name);
          if ( (typeof(outerVar) !== "undefined" && outerVar != null )  ) {
            newCtx_1 = (newCtx_1).set_captured_vars(operatorsOf_19.set_42(newCtx_1.captured_vars, b_3.name, (myVar)));
          }
        }
        ...
        newCtx_1 = (newCtx_1).set_variables(operatorsOf_19.set_42(newCtx_1.variables, b_3.name, (myVar)));
      } else {
        let err = new RError();
        err = (err).set_text(("Undefined variable " + b_3.name));
        newCtx_1 = (newCtx_1).set_errors(operatorsOf_3.push_43(newCtx_1.errors, (err)));
      }
      return newCtx_1;
    };
    if( ctx.activeNode instanceof RDefVariable ) /* union case */ {
      ...
      newCtx_2 = (newCtx_2).set_variables(operatorsOf_19.set_42(newCtx_2.variables, b_4.name, v));
      newCtx_2 = (newCtx_2).set_defined_vars(operatorsOf_19.set_42(newCtx_2.defined_vars, b_4.name, v));
      return newCtx_2;
    };
    return ctx;
  };
  testBlockAsReturn () {
    const b = operatorsOf_45.rc46block_46([operatorsOf_5.rc46def_44("x", "int"), operatorsOf_5.rc46def_44("y", "int"), operatorsOf_45.rc46expr_46([operatorsOf_5.rc46op_6("+"), operatorsOf_5.rc46vref_6("x"), operatorsOf_5.rc46vref_6("y")])]);
    return b;
  };
  testFnBlock () {
    const body = operatorsOf_45.rc46block_46([operatorsOf_45.rc46expr_46([operatorsOf_5.rc46op_6("return"), operatorsOf_45.rc46expr_46([operatorsOf_5.rc46op_6("+"), operatorsOf_5.rc46vref_6("x"), operatorsOf_5.rc46vref_6("y")])])]);
    const params = [operatorsOf_5.rc46param_44("x", "int"), operatorsOf_5.rc46param_44("y", "int")];
    const fnNode = operatorsOf_5.rc46fn_47("add", "int", params, body);
    return fnNode;
  };
  testSimpleInfix (infixName) {
    const plusop = operatorsOf_5.opc46collection_55(infixName, [operatorsOf_5.opc46def_50("js", "", [operatorsOf_5.opc46param_44("x", "int"), operatorsOf_5.opc46param_44("y", "int")], [operatorsOfint_48.cmdc46param_49(1), operatorsOf_5.cmdc46text_6(((" " + infixName) + " ")), operatorsOf_48.cmdc46param_49(2)])]);
    return plusop;
  };
  createJSString (opDef) {
    ...
    if( opDef instanceof ROperatorCollection ) /* union case */ {
      var op = opDef;
      const es6Op = operatorsOf_19.get_58(op.langs, "js");
      if ( (typeof(es6Op) !== "undefined" && es6Op != null )  ) {
        const op_1 = es6Op;
        operatorsOf_3.forEach_59(op_1.cmds, ((item) => { 
  ...
  createBlock (testCtx) {
    ...
    const b = operatorsOf_45.rc46block_46([operatorsOf_5.rc46def_44("x", "int"), operatorsOf_45.rc46expr_46([operatorsOf_5.rc46op_6("+"), operatorsOf_5.rc46vref_6("x"), operatorsOf_5.rc46vref_6("y")])]);
    let case_cnt = 0;
    ...
    ctx = (ctx).set_operators(operatorsOf_19.set_61(ctx.operators, "-", this.testSimpleInfix("-")));
    ctx = (ctx).set_operators(operatorsOf_19.set_61(ctx.operators, "*", this.testSimpleInfix("*")));
    ctx = (ctx).set_operators(operatorsOf_19.set_61(ctx.operators, "/", this.testSimpleInfix("/")));
    let cnt = 0;
    if( opDef instanceof ROperatorCollection ) /* union case */ {
      ...
      if ( (typeof(es6Op) !== "undefined" && es6Op != null )  ) {
        const op_1 = es6Op;
        cnt = cnt + 1;
        (testCtx).assert(operatorsOf_3.size_62(op_1.params) == 2, "+ Op has two params");
        (testCtx).assert(operatorsOf_3.size_63(op_1.cmds) == 3, "+ Op has three commands");
        let str = "";
        operatorsOf_3.forEach_59(op_1.cmds, ((item) => { 
          if( item instanceof ROpCmdWriteText ) /* union case */ {
            var writeTxt = item;
    ...
    if( opDef instanceof ROperatorCollection ) /* union case */ {
      var op_2 = opDef;
      ctx = (ctx).set_operators(operatorsOf_19.set_61(ctx.operators, op_2.name, opDef));
      const findOp = operatorsOf_19.get_64(ctx.operators, "+");
      ...
      if ( (typeof(operatorsOf_19.get_64(ctx.operators, "-")) !== "undefined" && operatorsOf_19.get_64(ctx.operators, "-") != null )  ) {
        testCtx.msg("- op was in context");
        const minusStr = this.createJSString((operatorsOf_19.get_64(ctx.operators, "-")));
  ...
  testClassifier (ctx) {
    ...
    if( ast instanceof RExpression ) /* union case */ {
      ...
      operatorsOf_9.forEach_40(new_children_1, ((item, index) => { 
  ...
  testTokenizer (testCtx) {
    ...
    out = (out).set_settings(new WriterSettings());
    console.log("--- ast out --- ");
    console.log(operatorsOf_25.getString_29(operatorsOf_12.print_65(res_ast, out)));
    let ctx = new writerCtx();
    ...
    if ( (typeof(resCtx.activeNode) !== "undefined" && resCtx.activeNode != null )  ) {
      ...
      operatorsOf_12.walk_13(node, ((item) => { 
        ...
        if( item instanceof RMaybeSQL ) /* union case */ {
          ...
          console.log(operatorsOf_25.getString_29(operatorsOf_12.print_65((n_1.node), out_2)));
        };
      }));
    }
  };
  blockCtxTest (testCtx) {
    ...
    ctx = (ctx).set_defined_types(operatorsOf_19.set_66(ctx.defined_types, "Vector<T>", (genTrait1)));
    let intType = new RType_Scalar();
    intType = (intType).set_bits(64);
    ctx = (ctx).set_defined_types(operatorsOf_19.set_66(ctx.defined_types, "int", (intType)));
    let en = new RType_Enum();
    en = (en).set_name("RValueEnum");
    en = (en).set_keys(operatorsOf_3.push_27(en.keys, "Int"));
    en = (en).set_keys(operatorsOf_3.push_27(en.keys, "String"));
    en = (en).set_keys(operatorsOf_3.push_27(en.keys, "Boolean"));
    en = (en).set_keys(operatorsOf_3.push_27(en.keys, "Double"));
    ctx = (ctx).set_defined_types(operatorsOf_19.set_66(ctx.defined_types, "RValueEnum", (en)));
    let someClass = new RType_Class();
    someClass = (someClass).set_name("MyClass");
    let xVal = new RType_Variable();
    xVal = (xVal).set_name("x");
    xVal = (xVal).set_value_type((operatorsOf_19.get_67(ctx.defined_types, "int")));
    someClass = (someClass).set_variables(operatorsOf_19.set_68(someClass.variables, "x", xVal));
    ctx = (ctx).set_defined_types(operatorsOf_19.set_66(ctx.defined_types, "MyClass", (someClass)));
    let objInstance = new RObjectInstance();
    objInstance = (objInstance).set_objectType((operatorsOf_19.get_67(ctx.defined_types, "MyClass")));
    ...
    vd2 = (vd2).set_name("Y");
    vd2 = (vd2).set_value((operatorsOf_48.literal_49(24)));
    ...
    (testCtx).assert((operatorsOf_19.keys_69(ctx.variables).length) == 6, "ctx should have definex 6 variables");
    operatorsOf_19.forEach_70(ctx.variables, ((item, index) => { 
      if ( index == "X" ) {
    ...
    walkFn = ((node) => { 
      ...
      if( node instanceof RBlockNode ) /* union case */ {
        ...
        operatorsOf_19.forEach_70(b.startCtx.variables, ((item, index) => { 
        ...
        operatorsOf_19.forEach_70(b.endCtx.variables, ((item, index) => { 
          if ( (typeof(item.value) !== "undefined" && item.value != null )  ) {
    ...
    (testCtx).assert(operatorsOf_3.size_71(ctx.errors) == 1, "Error count should be one");
    operatorsOf_3.forEach_72(ctx.errors, ((item) => { 
      if( item instanceof RError ) /* union case */ {
        var e_1 = item;
      };
    }));
    operatorsOf_9.forEach_36(operatorsOf_19.keys_74(ctx.defined_types), ((item, index) => { 
      const t = operatorsOf_19.get_67(ctx.defined_types, item);
      if( t instanceof RType_Class ) /* union case */ {
        var cl = t;
        operatorsOf_9.forEach_36(operatorsOf_19.keys_75(cl.variables), ((item, index) => { 
        }));
      };
    }));
  };
...
operatorsOf_3.forEach_34 = function(__self, cb) {
  const cnt_1 = (__self).count();
  let i_6 = 0;
  while (i_6 < cnt_1) {
    const item_1 = operatorsOf_3.itemAt_35(__self, i_6);
    cb(item_1);
    i_6 = i_6 + 1;
  };
};
operatorsOf_3.itemAt_35 = function(__self, idx) {
  const val_2 = (__self).get(idx);
  return val_2;
};
operatorsOf_3.map_38 = function(__self, cb) {
  let res_4 = [];
  const cnt_3 = (__self).count();
  let i_8 = 0;
  while (i_8 < cnt_3) {
    const item_2 = operatorsOf_3.itemAt_39(__self, i_8);
...
operatorsOf_3.push_43 = function(__self, item) {
  return __self.add(item);
};
operatorsOf_3.push_52 = function(__self, item) {
  return __self.add(item);
};
operatorsOf_3.push_54 = function(__self, item) {
  return __self.add(item);
};
operatorsOf_3.forEach_59 = function(__self, cb) {
  const cnt_4 = (__self).count();
  let i_15 = 0;
  while (i_15 < cnt_4) {
    const item_3 = operatorsOf_3.itemAt_60(__self, i_15);
    cb(item_3);
    i_15 = i_15 + 1;
  };
};
operatorsOf_3.itemAt_60 = function(__self, idx) {
...
operatorsOf_3.size_63 = function(__self) {
  return (__self).count();
};
operatorsOf_3.size_71 = function(__self) {
  return (__self).count();
};
operatorsOf_3.forEach_72 = function(__self, cb) {
  const cnt_5 = (__self).count();
  let i_20 = 0;
  while (i_20 < cnt_5) {
    const item_4 = operatorsOf_3.itemAt_73(__self, i_20);
    cb(item_4);
    i_20 = i_20 + 1;
  };
};
operatorsOf_3.itemAt_73 = function(__self, idx) {
...
operatorsOf_9.forEach_30 = function(__self, cb) {
  for ( let i_4 = 0; i_4 < __self.length; i_4++) {
    var it_1 = __self[i_4];
    cb(it_1, i_4);
  };
};
operatorsOf_9.forEach_36 = function(__self, cb) {
...
operatorsOf_9.forEach_51 = function(__self, cb) {
  for ( let i_11 = 0; i_11 < __self.length; i_11++) {
    var it_4 = __self[i_11];
    cb(it_4, i_11);
  };
};
operatorsOf_9.forEach_53 = function(__self, cb) {
...
operatorsOf_12.print_65 = function(res_ast, input) {
  let out = input;
  if( res_ast instanceof RExpression ) /* union case */ {
    var node_14 = res_ast;
    out = operatorsOf_25.write_26(out, "(");
    ...
    operatorsOf_3.forEach_14(node_14.children, ((item) => { 
      out = operatorsOf_12.print_65(item, out);
    }));
    out = operatorsOf_25.nl_29(out);
    out = operatorsOf_25.unindent_29(out);
    out = operatorsOf_25.write_26(out, ")");
  ...
  if( res_ast instanceof RVRefNode ) /* union case */ {
    var node_16 = res_ast;
    return operatorsOf_25.write_26(out, (" " + node_16.vref));
  };
  if( res_ast instanceof RBooleanValue ) /* union case */ {
    var node_17 = res_ast;
    if ( node_17.value ) {
      out = operatorsOf_25.write_26(out, " true");
    } else {
      out = operatorsOf_25.write_26(out, " false");
    }
  };
  if( res_ast instanceof RDoubleValue ) /* union case */ {
    var node_18 = res_ast;
    out = operatorsOf_25.write_26(out, (" " + node_18.value));
  };
  if( res_ast instanceof RIntValue ) /* union case */ {
    var node_19 = res_ast;
    out = operatorsOf_25.write_26(out, (" " + node_19.value));
  };
  if( res_ast instanceof RStringValue ) /* union case */ {
    var node_20 = res_ast;
    out = operatorsOf_25.write_26(out, (("`" + node_20.value) + "`"));
  };
  return out;
};
class operatorsOfRNodeIterator_17  {
  constructor() {
  }
}
operatorsOfRNodeIterator_17.cut_18 = function(res_ast, cb) {
  let res = res_ast;
...
class operatorsOfMap_19  {
  constructor() {
  }
}
operatorsOfMap_19.set_20 = function(__self, key, value) {
...
operatorsOf_19.keys_21 = function(__self) {
  return Object.keys(__self.elements);
};
operatorsOf_19.forEach_24 = function(__self, cb) {
...
operatorsOf_19.set_31 = function(__self, key, value) {
...
operatorsOf_19.get_32 = function(__self, key) {
  return __self.elements[key];
};
operatorsOf_19.get_41 = function(__self, key) {
  return __self.elements[key];
};
operatorsOf_19.set_42 = function(__self, key, value) {
...
operatorsOf_19.set_57 = function(__self, key, value) {
...
operatorsOf_19.get_58 = function(__self, key) {
  return __self.elements[key];
};
operatorsOf_19.set_61 = function(__self, key, value) {
...
operatorsOf_19.get_64 = function(__self, key) {
  return __self.elements[key];
};
operatorsOf_19.set_66 = function(__self, key, value) {
...
operatorsOf_19.get_67 = function(__self, key) {
  return __self.elements[key];
};
operatorsOf_19.set_68 = function(__self, key, value) {
...
operatorsOf_19.keys_69 = function(__self) {
  return Object.keys(__self.elements);
};
operatorsOf_19.forEach_70 = function(__self, cb) {
...
operatorsOf_19.keys_74 = function(__self) {
  return Object.keys(__self.elements);
};
operatorsOf_19.keys_75 = function(__self) {
  return Object.keys(__self.elements);
};
class operatorsOf_5  {
  constructor() {
...
operatorsOf_5.rc46def_44 = function(name, typename) {
  let vd = new RDefVariable();
  vd = (vd).set_name(name);
  vd = (vd).set_typename("");
  return vd;
...
operatorsOf_5.rc46param_44 = function(name, type_name) {
  let p = new RFunctionParam();
  p = (p).set_name(name);
  p = (p).set_type_name(type_name);
  return p;
};
operatorsOf_5.rc46fn_47 = function(name, rvType, params, body) {
  let f = new RFunction();
  f = (f).set_name(name);
  f = (f).set_rvType(rvType);
  operatorsOf_9.forEach_40(params, ((item, index) => { 
    f = (f).set_params(operatorsOf_3.push_11(f.params, item));
  }));
  f = (f).set_body(body);
  return f;
};
operatorsOf_5.opc46param_44 = function(name, type_name) {
...
operatorsOf_5.opc46def_50 = function(lang, versions, params, cmds) {
  let n_2 = new ROperatorDef();
  n_2 = (n_2).set_lang(lang);
  n_2 = (n_2).set_versions(versions);
  operatorsOf_9.forEach_51(params, ((item, index) => { 
    n_2 = (n_2).set_params(operatorsOf_3.push_52(n_2.params, item));
  }));
  operatorsOf_9.forEach_53(cmds, ((item, index) => { 
    n_2 = (n_2).set_cmds(operatorsOf_3.push_54(n_2.cmds, item));
  }));
  return n_2;
};
operatorsOf_5.opc46collection_55 = function(opName, params) {
  let n_3 = new ROperatorCollection();
  n_3 = (n_3).set_name(opName);
  operatorsOf_9.forEach_56(params, ((item, index) => { 
    n_3 = (n_3).set_langs(operatorsOf_19.set_57(n_3.langs, item.lang, item));
  }));
  return n_3;
};
...
class operatorsOfgrammarCtx_22  {
  constructor() {
  }
}
operatorsOfgrammarCtx_22.collect_23 = function(ctx) {
  const res_1 = ctx;
  operatorsOf_19.forEach_24(ctx.rules, ((item, index) => { 
  ...
  if ( (typeof(ctx.codevec) !== "undefined" && ctx.codevec != null )  ) {
    ...
    if ( (typeof(valueMaybe) !== "undefined" && valueMaybe != null )  ) {
      ...
      if( value instanceof RVRefNode ) /* union case */ {
        var v = value;
        console.log("the first value was VREF! == " + v.vref);
      };
    }
  }
  return res_1;
};
class operatorsOfCodeOutput_25  {
  constructor() {
  }
}
operatorsOfCodeOutput_25.write_26 = function(out, str) {
  let newOut = out;
  let slice = new CodeSlice();
  slice = (slice).set_tokens(operatorsOf_3.push_27(slice.tokens, str));
  newOut = (newOut).set_slices(operatorsOf_3.push_28(newOut.slices, (slice)));
  return newOut;
};
...
operatorsOf_25.nl_29 = function(out) {
  let newOut_1 = out;
  newOut_1 = (newOut_1).set_slices(operatorsOf_3.push_28(newOut_1.slices, (new WriterCmdNewLine())));
  return newOut_1;
};
operatorsOf_25.indent_29 = function(out) {
  let newOut_2 = out;
  newOut_2 = (newOut_2).set_slices(operatorsOf_3.push_28(newOut_2.slices, (new WriterCmdIndent())));
  return newOut_2;
};
operatorsOf_25.write_26 = function(out, str) {
  let newOut_3 = out;
  let slice_1 = new CodeSlice();
  slice_1 = (slice_1).set_tokens(operatorsOf_3.push_27(slice_1.tokens, str));
  newOut_3 = (newOut_3).set_slices(operatorsOf_3.push_28(newOut_3.slices, (slice_1)));
  return newOut_3;
};
operatorsOf_25.unindent_29 = function(out) {
  let newOut_4 = out;
  newOut_4 = (newOut_4).set_slices(operatorsOf_3.push_28(newOut_4.slices, (new WriterCmdUnIndent())));
  return newOut_4;
};
operatorsOf_25.fork_29 = function(out) {
  let newOut_5 = new CodeOutput();
  newOut_5 = (newOut_5).set_settings(out.settings);
  return newOut_5;
};
operatorsOf_25.getString_33 = function(out, indentLevel, currentLine) {
  let res_2 = "";
  let curr_line = currentLine;
  let indent = indentLevel;
  operatorsOf_3.forEach_34(out.slices, ((item) => { 
    if( item instanceof CodeOutput ) /* union case */ {
      var s = item;
      const the_string = operatorsOf_25.getString_33(s, indent, curr_line);
      const lines = the_string.split("\n");
      operatorsOf_9.forEach_36(lines, ((item, index) => { 
        if ( index == 0 ) {
          if ( (curr_line.length) == 0 ) {
            curr_line = curr_line + operatorsOf_25.getTabStr_37(out, indent);
            res_2 = res_2 + operatorsOf_25.getTabStr_37(out, indent);
          }
          curr_line = curr_line + item;
          res_2 = res_2 + item;
        } else {
          res_2 = res_2 + out.settings.newlineStr;
          res_2 = (res_2 + operatorsOf_25.getTabStr_37(out, indent)) + item;
          curr_line = operatorsOf_25.getTabStr_37(out, indent) + item;
        }
      }));
    };
    if( item instanceof CodeSlice ) /* union case */ {
      var s_1 = item;
      const the_string_1 = operatorsOf_3.map_38(s_1.tokens, ((item) => { 
        const str = item;
        return str;
      })).join("");
      const lines_1 = the_string_1.split("\n");
      operatorsOf_9.forEach_36(lines_1, ((item, index) => { 
        if ( index == 0 ) {
          if ( (curr_line.length) == 0 ) {
            curr_line = curr_line + operatorsOf_25.getTabStr_37(out, indent);
            res_2 = res_2 + operatorsOf_25.getTabStr_37(out, indent);
    ...
    if( item instanceof WriterTag ) /* union case */ {
      var s_2 = item;
      const tag = operatorsOf_19.get_32(out.tags, s_2.name);
      if ( (typeof(tag) !== "undefined" && tag != null )  ) {
        const codeOutTag = tag;
        const the_string_2 = operatorsOf_25.getString_33(codeOutTag, indent, curr_line);
        const lines_2 = the_string_2.split("\n");
        operatorsOf_9.forEach_36(lines_2, ((item, index) => { 
          if ( index == 0 ) {
            if ( (curr_line.length) == 0 ) {
              curr_line = curr_line + operatorsOf_25.getTabStr_37(out, indent);
              res_2 = res_2 + operatorsOf_25.getTabStr_37(out, indent);
...
operatorsOf_25.getTabStr_37 = function(out, indentLevel) {
  if ( indentLevel == 0 ) {
    return "";
  }
...
operatorsOf_25.getString_29 = function(out) {
  return operatorsOf_25.getString_33(out, 0, "");
};
class operatorsOf_45  {
  constructor() {
  }
}
operatorsOf_45.rc46expr_46 = function(children) {
  let n = new RExpression();
  operatorsOf_9.forEach_40(children, ((item, index) => { 
    n = (n).set_children(operatorsOf_3.push_11(n.children, item));
  }));
  return n;
};
operatorsOf_45.rc46block_46 = function(children) {
...
class operatorsOfint_48  {
  constructor() {
  }
}
operatorsOfint_48.cmdc46param_49 = function(index) {
...
operatorsOf_48.cmdc46param_49 = function(index) {
  let p_4 = new ROpCmdParam();
  p_4 = (p_4).set_index(index);
  return p_4;
};
operatorsOf_48.literal_49 = function(v) {
  let sca_1 = new RType_Literal();
  sca_1 = (sca_1).set_int_value(v);
  sca_1 = (sca_1).set_value_type(1);
  return sca_1;
};
class operatorsOfJSONArrayObject_76  {
  constructor() {
  }
}
operatorsOfJSONArrayObject_76.forEach_77 = function(__self, cb) {
...
class operatorsOf_76  {
  constructor() {
  }
}
operatorsOf_76.forEach_77 = function(__self, cb) {
...
function __js_main() {
  try {
    ...
    operatorsOf_9.forEach_36(ctx.messages, ((item, index) => { 
      console.log("  * " + item);
    }));
    if ( (ctx.errors.length) > 0 ) {
      operatorsOf_9.forEach_36(ctx.errors, ((item, index) => { 
